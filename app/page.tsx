    ...
    <div className={`${robotoCondensed.variable} ${orbitron.variable} min-h-screen bg-white`}>
      ...
      <section className="relative h-[85vh] w-full overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 sm:px-6 text-center md:text-left md:items-start md:justify-center md:pl-8 lg:pl-36">
          ...
          <p className="text-sm sm:text-base md:text-xl lg:text-3xl font-roboto-condensed font-medium text-white uppercase mb-6 md:mb-8 relative z-10">
            11-12 December 2026 Nürnberg, Germany
          </p>
          <Link
            href="/registration"
      ...
      <section className="relative py-12 md:py-8 sm:py-12 md:py-16 px-4 sm:px-6">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 text-center">
            ...
            <div>
              <div className="text-2xl sm:text-3xl md:text-5xl font-orbitron font-bold text-[#FE6448] mb-1 md:mb-2">120+</div>
              <div className="text-sm sm:text-base md:text-2xl font-roboto-condensed font-light text-[#FE6448] uppercase">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="bg-[#FE6448] rounded-lg px-8 py-6 text-white mb-8">
            <h3 className="text-xl font-orbitron font-bold uppercase text-center mb-6">
              Day 1 : Friday, 11th December 2026
            </h3>
            <p className="text-center font-roboto-condensed font-bold uppercase mb-8 text-white/90">
              Presidential Gala Dinner @ Germanisches Nationalmuseum
            </p>
            <div className="space-y-6">
              <div className="grid md:grid-cols-[1fr_7fr] gap-4 items-start">
                <div className="font-orbitron font-bold text-lg">17:30</div>
                <div>
                  <h4 className="font-roboto-condensed font-bold uppercase text-lg">Beginning & Snacks</h4>
                  <p className="font-roboto-condensed font-light">
                    Guided Museum Visit (30 min) - Exclusive tour of selected collections.
                  </p>
                </div>
              </div>
              <div className="grid md:grid-cols-[1fr_7fr] gap-4 items-start">
                <div className="font-orbitron font-bold text-lg">18:00</div>
                <div>
                  <h4 className="font-roboto-condensed font-bold uppercase text-lg">Opening Ceremony</h4>
                  <p className="font-roboto-condensed font-light">
                    Welcome addresses from congress leadership and institutional partners.
                  </p>
                </div>
              </div>
              <div className="grid md:grid-cols-[1fr_7fr] gap-4 items-start">
                <div className="font-orbitron font-bold text-lg">19:30</div>
                <div>
                  <h4 className="font-roboto-condensed font-bold uppercase text-lg">Gala Dinner & Awards</h4>
                  <p className="font-roboto-condensed font-light">
                    Festive Gala Dinner with artistic performances "Music & Art meets Medical Technology".
                  </p>
                </div>
              </div>
              <div className="grid md:grid-cols-[1fr_7fr] gap-4 items-start">
                <div className="font-orbitron font-bold text-lg">20:30</div>
                <div>
                  <h4 className="font-roboto-condensed font-bold uppercase text-lg">Artistic Programme</h4>
                  <p className="font-roboto-condensed font-light">
                    Performance by Atac Sezer and Quartet.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="bg-[#FE6448] py-8 sm:py-12 md:py-16 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center text-white">
            ...
            <div>
              <div className="text-lg md:text-xl lg:text-2xl font-orbitron font-black uppercase mb-2">11 December 2026</div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl md:text-4xl font-orbitron font-bold text-[#85AFFB] uppercase">
              Klinikum Nuremberg Nord - Haus 57, Nuremberg
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <img
                src="/klinikum-nuremberg-nord-haus57.jpg"
                alt="Klinikum Nuremberg Nord - Haus 57"
            ...
            <div className="text-white font-roboto-condensed">
              <p className="text-base md:text-lg lg:text-xl mb-6">
                ...
                <span className="font-bold">Klinikum Nuremberg Nord - Haus 57</span>, a modern medical facility perfectly suited for our congress.
              </p>
      ...
      <section className="bg-gray-50 py-16 px-4 relative overflow-hidden">
        <div className="max-w-5xl mx-auto relative z-10">
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-xl border-l-8 border-[#FE6448] flex flex-col md:flex-row items-center gap-8 md:gap-12 transform hover:-translate-y-1 transition-transform duration-300">
            <div className="flex-shrink-0 bg-[#0D1858] p-6 rounded-full">
              <span className="text-5xl">🌱</span>
            </div>
            <div className="text-center md:text-left">
              <h2 className="text-2xl md:text-3xl font-orbitron font-black text-[#0D1858] uppercase mb-3">
                We Are Going Paperless
              </h2>
              <p className="text-lg md:text-xl font-roboto-condensed text-gray-700 leading-relaxed">
                <span className="font-bold text-[#FE6448]">Sustainable Impact:</span> For every congress participant, we will plant a tree — a tangible contribution to environmental protection.
              </p>
            </div>
          </div>
        </div>
