        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-[#0D1858] rounded-lg p-8 text-white">
              ...
              <p className="font-roboto-condensed text-lg mb-4">11 - 12 December 2026</p>
              <p className="font-roboto-condensed text-base">Two days of innovation, collaboration, and advancement</p>
            </div>

            <div className="bg-[#FE6448] rounded-lg p-8 text-white">
              <h3 className="font-orbitron font-bold uppercase text-xl mb-6">Where</h3>
              <p className="font-roboto-condensed text-lg mb-4">Klinikum Nuremberg Nord - Haus 57</p>
              <p className="font-roboto-condensed text-base">Prof.-Ernst-Nathan-Straße 1, 90419 Nuremberg, Germany</p>
            </div>
          </div>
        </div>
      </section>
